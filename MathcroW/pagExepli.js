...
function exponencial(){
    ...
    expliMud.innerHTML = "<h3>Exponenial</h3> <p>Uma função exponencial é expressa por:</p> <h2><strong>f(n) = aⁿ</strong></h2> <p>a: É um valor constante(O valor não muda). <br> x: a o valor que vai mudar.</p> <p> f(x): representa a saída ou o resultado da função quando um determinado valor é colocado no lugar de x <br> A base deve ser sempre a > 0 (a maior que zero)<br> <br> a != 1 (diferente de 1)<br> Para garantir um comportamento de crescimento ou decaimento real.<br> </p> <h3> Função Cresente</h3> <p>Comportamento: À medida que o valor de x aumenta, o valor de y ou f(x) também aumenta rapidamente. <br> <br>A função é crescente quando a base é maior que 1 (a > 1) </p> <h3>Função Decrecente</h3> <p>A função é decrescente quando a base é maior que 0 e menor que 1 (0 < a < 1). <br> <br>Comportamento: À medida que o valor de x aumenta, o valor de y diminui, aproximando-se de zero, mas sem nunca tocá-lo. <br> <br>Exemplos Algébricos e Práticos <br> <br>São exemplos clássicos de leis de funções exponenciais decrescentes: <br>* f(x) = (1/2)X <br> * f(x) = (0,8)X </p>";
    exempMud.innerHTML = "<p>Exemplo:  <br> <br>•  Exemplos: f(x) = 2x,  f(x) = 5x, f(x) = 10x.. <br>•  Exemplo Prático y = 2^x:<br>•	Se x = 0, y = 2^0 = 1.<br>•	Se x = 1, y = 2^1 = 2.<br>•	Se x = 2, y = 2^2 = 4.<br>•	Se x = 3, y = 2^3 = 8.<br> </p> <p>Exemplo:<br> <br> F(x) = 2x<br> <br>•  Se x = 0, temos f(0) = 20 = 1 <br>•  Se x = 1, temos f(1) = 21 = 2<br>•  Se x = 2, temos f(2) = 22 = 4<br>•  Se x = -1, temos f(-1) = 2-1 = ½= 0,5<br><br>Neste exemplo, como a base 2 é maior que 1, trata-se de uma função crescente, cujo gráfico intercepta o eixo y exatamente no ponto 0, 1.</p> <img src='../img/grafic1.png'> <p> São exemplos clássicos de leis de funções exponenciais decrescentes: <br>* f(x) = (1/2)X <br>* f(x) = (0,8)X<br> <br>Mapeamento de Valores para f(x) = (1/2)^x <br> <br>Valor de x Cálculo Exponencial Valor de y<br> <br>x = 0 y = (1/2)0 = 1        y = 1,0<br>x = 1 y = (1/2)1 = 1/2    y = 0,5<br>x = 2 y = (1/2)2 = 1/4    y = 0,25<br>x = 3 y = (1/2)3 = 1/8    y = 0,125<br><br></p> <img src='../img/grafic2.png'>"
